                                                     ...
                                                     uInt *psize_local_extrafield)
{
    ...
    *psize_local_extrafield = 0;
    ...
    if (ZSEEK64(s->z_filefunc, s->filestream, s->cur_file_info_internal.offset_curfile + s->cur_file_info_internal.byte_before_the_zipfile, ZLIB_FILEFUNC_SEEK_SET) != 0)
        return UNZ_ERRNO;
