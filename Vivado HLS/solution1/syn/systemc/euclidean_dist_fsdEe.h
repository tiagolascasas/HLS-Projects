...
// ==============================================================
#ifndef __euclidean_dist_fsdEe__HH__
#define __euclidean_dist_fsdEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(euclidean_dist_fsdEe) {
    ...
    SC_CTOR(euclidean_dist_fsdEe):  ACMP_fsqrt_U ("ACMP_fsqrt_U") {
