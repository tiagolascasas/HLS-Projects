...
void fdct(short dct_io_ptr[256], short dct_o[256], int num_fdcts)
{
    ...
    {
        n_dct_io_ptr[_i]++;
        fprintf(log_file_0, "\"dct_io_ptr[%d]_%d_l\" [label=\"dct_io_ptr[%d]\", att1=var, att2=inte, att3=short];\n", _i, n_dct_io_ptr[_i], _i);
    }
    for (int _i = 0; _i < 256; _i++)
    {
        n_dct_o[_i]++;
    ...
    n_num_fdcts++;
    fprintf(log_file_0, "\"num_fdcts_%d\" [label=\"num_fdcts\", att1=var, att2=inte, att3=int];\n", n_num_fdcts);
    ...
    //---------------------
    n_const++;
    fprintf(log_file_0, "\"const%d\" [label=\"11362\", att1=const];\n", n_const);
    n_c1++;
    fprintf(log_file_0, "\"c1_%d\" [label=\"c1\", att1=var, att2=loc, att3=short];\n", n_c1);
    n_ne++;
    ...
    //---------------------
    n_const++;
    fprintf(log_file_0, "\"const%d\" [label=\"6436\", att1=const];\n", n_const);
    n_c5++;
    fprintf(log_file_0, "\"c5_%d\" [label=\"c5\", att1=var, att2=loc, att3=short];\n", n_c5);
    n_ne++;
    ...
    //---------------------
    n_const++;
    fprintf(log_file_0, "\"const%d\" [label=\"46341\", att1=const];\n", n_const);
    n_c0++;
    ...
    //---------------------
    n_const++;
    fprintf(log_file_0, "\"const%d\" [label=\"4433\", att1=const];\n", n_const);
    n_c6++;
    fprintf(log_file_0, "\"c6_%d\" [label=\"c6\", att1=var, att2=loc, att3=short];\n", n_c6);
    n_ne++;
    fprintf(log_file_0, "\"const%d\" -> \"c6_%d\" [label=\"%d\", ord=\"%d\"];", n_const, n_c6, n_ne, n_ne);
    //---------------------
    ...
    n_i_1++;
    fprintf(log_file_0, "\"i_1_%d\" [label=\"i_1\", att1=var, att2=loc, att3=int];\n", n_i_1);
    n_ne++;
    fprintf(log_file_0, "\"const%d\" -> \"i_1_%d\" [label=\"%d\", ord=\"%d\"];", n_const, n_i_1, n_ne, n_ne);
    //---------------------
    i_1 = 0;
    for (i = 0; i < num_fdcts; i++)
    {
        for (j = 0; j < 8; j++)
        {
            ...
            n_ne++;
            fprintf(log_file_0, "\"f7_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"r\"];", n_f7, n_op, n_ne, n_ne);
            n_ne++;
            fprintf(log_file_0, "\"f0_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"l\"];", n_f0, n_op, n_ne, n_ne);
            n_temp++;
            ...
            n_ne++;
            fprintf(log_file_0, "\"temp%d\" -> \"g0_%d\" [label=\"%d\", ord=\"%d\"];", n_temp, n_g0, n_ne, n_ne);
            //---------------------
            g0 = f0 + f7;
            //---------------------
            n_op++;
            ...
            n_ne++;
            fprintf(log_file_0, "\"temp%d\" -> \"h2_%d\" [label=\"%d\", ord=\"%d\"];", n_temp, n_h2, n_ne, n_ne);
            //---------------------
            h2 = f0 - f7;
            //---------------------
            n_op++;
            fprintf(log_file_0, "\"op%d\" [label=\"+\", att1=op];\n", n_op);
            n_ne++;
            fprintf(log_file_0, "\"f6_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"r\"];", n_f6, n_op, n_ne, n_ne);
            n_ne++;
            fprintf(log_file_0, "\"f1_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"l\"];", n_f1, n_op, n_ne, n_ne);
            n_temp++;
            fprintf(log_file_0, "\"temp%d\" [label=\"temp%d\", att1=var, att2=loc, att3=float];\n", n_temp, n_temp);
            n_ne++;
            fprintf(log_file_0, "\"op%d\" -> \"temp%d\" [label=\"%d\", ord=\"%d\"];", n_op, n_temp, n_ne, n_ne);
            ...
            n_ne++;
            fprintf(log_file_0, "\"temp%d\" -> \"g1_%d\" [label=\"%d\", ord=\"%d\"];", n_temp, n_g1, n_ne, n_ne);
            //---------------------
            g1 = f1 + f6;
            //---------------------
            n_op++;
            ...
            n_ne++;
            fprintf(log_file_0, "\"temp%d\" -> \"h3_%d\" [label=\"%d\", ord=\"%d\"];", n_temp, n_h3, n_ne, n_ne);
            //---------------------
            h3 = f1 - f6;
            //---------------------
            n_op++;
            fprintf(log_file_0, "\"op%d\" [label=\"+\", att1=op];\n", n_op);
            n_ne++;
            fprintf(log_file_0, "\"f5_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"r\"];", n_f5, n_op, n_ne, n_ne);
            n_ne++;
            fprintf(log_file_0, "\"f2_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"l\"];", n_f2, n_op, n_ne, n_ne);
            n_temp++;
            fprintf(log_file_0, "\"temp%d\" [label=\"temp%d\", att1=var, att2=loc, att3=float];\n", n_temp, n_temp);
            n_ne++;
            fprintf(log_file_0, "\"op%d\" -> \"temp%d\" [label=\"%d\", ord=\"%d\"];", n_op, n_temp, n_ne, n_ne);
            ...
            n_ne++;
            fprintf(log_file_0, "\"temp%d\" -> \"h1_%d\" [label=\"%d\", ord=\"%d\"];", n_temp, n_h1, n_ne, n_ne);
            //---------------------
            h1 = f2 + f5;
            //---------------------
            n_op++;
            ...
            n_ne++;
            fprintf(log_file_0, "\"temp%d\" -> \"g3_%d\" [label=\"%d\", ord=\"%d\"];", n_temp, n_g3, n_ne, n_ne);
            //---------------------
            g3 = f2 - f5;
            //---------------------
            n_op++;
            fprintf(log_file_0, "\"op%d\" [label=\"+\", att1=op];\n", n_op);
            n_ne++;
            fprintf(log_file_0, "\"f4_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"r\"];", n_f4, n_op, n_ne, n_ne);
            n_ne++;
            fprintf(log_file_0, "\"f3_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"l\"];", n_f3, n_op, n_ne, n_ne);
            n_temp++;
            fprintf(log_file_0, "\"temp%d\" [label=\"temp%d\", att1=var, att2=loc, att3=float];\n", n_temp, n_temp);
            n_ne++;
            fprintf(log_file_0, "\"op%d\" -> \"temp%d\" [label=\"%d\", ord=\"%d\"];", n_op, n_temp, n_ne, n_ne);
            ...
            n_ne++;
            fprintf(log_file_0, "\"temp%d\" -> \"h0_%d\" [label=\"%d\", ord=\"%d\"];", n_temp, n_h0, n_ne, n_ne);
            //---------------------
            h0 = f3 + f4;
            //---------------------
            n_op++;
            ...
            n_ne++;
            fprintf(log_file_0, "\"temp%d\" -> \"g2_%d\" [label=\"%d\", ord=\"%d\"];", n_temp, n_g2, n_ne, n_ne);
            //---------------------
            g2 = f3 - f4;
            //---------------------
            n_op++;
            fprintf(log_file_0, "\"op%d\" [label=\"+\", att1=op];\n", n_op);
            n_ne++;
            fprintf(log_file_0, "\"h0_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"r\"];", n_h0, n_op, n_ne, n_ne);
            n_ne++;
            fprintf(log_file_0, "\"g0_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"l\"];", n_g0, n_op, n_ne, n_ne);
            n_temp++;
            fprintf(log_file_0, "\"temp%d\" [label=\"temp%d\", att1=var, att2=loc, att3=float];\n", n_temp, n_temp);
            n_ne++;
            fprintf(log_file_0, "\"op%d\" -> \"temp%d\" [label=\"%d\", ord=\"%d\"];", n_op, n_temp, n_ne, n_ne);
            ...
            n_ne++;
            fprintf(log_file_0, "\"temp%d\" -> \"p0_%d\" [label=\"%d\", ord=\"%d\"];", n_temp, n_p0, n_ne, n_ne);
            //---------------------
            p0 = g0 + h0;
            //---------------------
            n_op++;
            ...
            n_ne++;
            fprintf(log_file_0, "\"temp%d\" -> \"r0_%d\" [label=\"%d\", ord=\"%d\"];", n_temp, n_r0, n_ne, n_ne);
            //---------------------
            r0 = g0 - h0;
            //---------------------
            n_op++;
            fprintf(log_file_0, "\"op%d\" [label=\"+\", att1=op];\n", n_op);
            n_ne++;
            fprintf(log_file_0, "\"h1_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"r\"];", n_h1, n_op, n_ne, n_ne);
            n_ne++;
            fprintf(log_file_0, "\"g1_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"l\"];", n_g1, n_op, n_ne, n_ne);
            n_temp++;
            fprintf(log_file_0, "\"temp%d\" [label=\"temp%d\", att1=var, att2=loc, att3=float];\n", n_temp, n_temp);
            n_ne++;
            fprintf(log_file_0, "\"op%d\" -> \"temp%d\" [label=\"%d\", ord=\"%d\"];", n_op, n_temp, n_ne, n_ne);
            ...
            n_ne++;
            fprintf(log_file_0, "\"temp%d\" -> \"p1_%d\" [label=\"%d\", ord=\"%d\"];", n_temp, n_p1, n_ne, n_ne);
            //---------------------
            p1 = g1 + h1;
            //---------------------
            n_op++;
            ...
            n_ne++;
            fprintf(log_file_0, "\"temp%d\" -> \"r1_%d\" [label=\"%d\", ord=\"%d\"];", n_temp, n_r1, n_ne, n_ne);
            //---------------------
            r1 = g1 - h1;
            //---------------------
            n_q1++;
            ...
            fprintf(log_file_0, "\"op%d\" [label=\"+\", att1=op];\n", n_op);
            n_ne++;
            fprintf(log_file_0, "\"g3_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"r\"];", n_g3, n_op, n_ne, n_ne);
            n_ne++;
            fprintf(log_file_0, "\"h3_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"l\"];", n_h3, n_op, n_ne, n_ne);
            n_temp++;
            fprintf(log_file_0, "\"temp%d\" [label=\"temp%d\", att1=var, att2=loc, att3=float];\n", n_temp, n_temp);
            n_ne++;
            fprintf(log_file_0, "\"op%d\" -> \"temp%d\" [label=\"%d\", ord=\"%d\"];", n_op, n_temp, n_ne, n_ne);
            ...
            n_ne++;
            fprintf(log_file_0, "\"temp%d\" -> \"s0a_%d\" [label=\"%d\", ord=\"%d\"];", n_temp, n_s0a, n_ne, n_ne);
            //---------------------
            s0a = h3 + g3;
            //---------------------
            n_op++;
            ...
            n_ne++;
            fprintf(log_file_0, "\"temp%d\" -> \"q0a_%d\" [label=\"%d\", ord=\"%d\"];", n_temp, n_q0a, n_ne, n_ne);
            //---------------------
            q0a = h3 - g3;
            //---------------------
            n_const++;
            fprintf(log_file_0, "\"const%d\" [label=\"32767\", att1=const];\n", n_const);
            n_op++;
            fprintf(log_file_0, "\"op%d\" [label=\"*\", att1=op];\n", n_op);
            n_ne++;
            fprintf(log_file_0, "\"c0_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"r\"];", n_c0, n_op, n_ne, n_ne);
            n_ne++;
            fprintf(log_file_0, "\"s0a_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"l\"];", n_s0a, n_op, n_ne, n_ne);
            n_temp++;
            fprintf(log_file_0, "\"temp%d\" [label=\"temp%d\", att1=var, att2=loc, att3=float];\n", n_temp, n_temp);
            n_ne++;
            fprintf(log_file_0, "\"op%d\" -> \"temp%d\" [label=\"%d\", ord=\"%d\"];", n_op, n_temp, n_ne, n_ne);
            ...
            fprintf(log_file_0, "\"op%d\" [label=\"+\", att1=op];\n", n_op);
            n_ne++;
            fprintf(log_file_0, "\"const%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"r\"];", n_const, n_op, n_ne, n_ne);
            n_ne++;
            fprintf(log_file_0, "\"temp%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"l\"];", n_temp, n_op, n_ne, n_ne);
            n_temp++;
            fprintf(log_file_0, "\"temp%d\" [label=\"temp%d\", att1=var, att2=loc, att3=float];\n", n_temp, n_temp);
            n_ne++;
            fprintf(log_file_0, "\"op%d\" -> \"temp%d\" [label=\"%d\", ord=\"%d\"];", n_op, n_temp, n_ne, n_ne);
            ...
            n_ne++;
            fprintf(log_file_0, "\"temp%d\" -> \"s0_%d\" [label=\"%d\", ord=\"%d\"];", n_temp, n_s0, n_ne, n_ne);
            //---------------------
            s0 = (s0a * c0 + 0x7FFF) >> 16;
            //---------------------
            n_const++;
            ...
            fprintf(log_file_0, "\"c0_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"r\"];", n_c0, n_op, n_ne, n_ne);
            n_ne++;
            fprintf(log_file_0, "\"q0a_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"l\"];", n_q0a, n_op, n_ne, n_ne);
            n_temp++;
            fprintf(log_file_0, "\"temp%d\" [label=\"temp%d\", att1=var, att2=loc, att3=float];\n", n_temp, n_temp);
            n_ne++;
            fprintf(log_file_0, "\"op%d\" -> \"temp%d\" [label=\"%d\", ord=\"%d\"];", n_op, n_temp, n_ne, n_ne);
            ...
            n_ne++;
            fprintf(log_file_0, "\"temp%d\" -> \"q0_%d\" [label=\"%d\", ord=\"%d\"];", n_temp, n_q0, n_ne, n_ne);
            //---------------------
            q0 = (q0a * c0 + 0x7FFF) >> 16;
            //---------------------
            n_op++;
            fprintf(log_file_0, "\"op%d\" [label=\"+\", att1=op];\n", n_op);
            n_ne++;
            fprintf(log_file_0, "\"p1_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"r\"];", n_p1, n_op, n_ne, n_ne);
            n_ne++;
            fprintf(log_file_0, "\"p0_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"l\"];", n_p0, n_op, n_ne, n_ne);
            n_temp++;
            fprintf(log_file_0, "\"temp%d\" [label=\"temp%d\", att1=var, att2=loc, att3=float];\n", n_temp, n_temp);
            n_ne++;
            fprintf(log_file_0, "\"op%d\" -> \"temp%d\" [label=\"%d\", ord=\"%d\"];", n_op, n_temp, n_ne, n_ne);
            ...
            fprintf(log_file_0, "\"op%d\" [label=\"*\", att1=op];\n", n_op);
            n_ne++;
            fprintf(log_file_0, "\"r0_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"r\"];", n_r0, n_op, n_ne, n_ne);
            n_ne++;
            fprintf(log_file_0, "\"c2_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"l\"];", n_c2, n_op, n_ne, n_ne);
            n_temp++;
            fprintf(log_file_0, "\"temp%d\" [label=\"temp%d\", att1=var, att2=loc, att3=float];\n", n_temp, n_temp);
            n_ne++;
            fprintf(log_file_0, "\"op%d\" -> \"temp%d\" [label=\"%d\", ord=\"%d\"];", n_op, n_temp, n_ne, n_ne);
            ...
            fprintf(log_file_0, "\"op%d\" [label=\"*\", att1=op];\n", n_op);
            n_ne++;
            fprintf(log_file_0, "\"r1_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"r\"];", n_r1, n_op, n_ne, n_ne);
            n_ne++;
            fprintf(log_file_0, "\"c6_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"l\"];", n_c6, n_op, n_ne, n_ne);
            n_temp++;
            fprintf(log_file_0, "\"temp%d\" [label=\"temp%d\", att1=var, att2=loc, att3=float];\n", n_temp, n_temp);
            n_ne++;
            fprintf(log_file_0, "\"op%d\" -> \"temp%d\" [label=\"%d\", ord=\"%d\"];", n_op, n_temp, n_ne, n_ne);
            ...
            fprintf(log_file_0, "\"op%d\" [label=\"+\", att1=op];\n", n_op);
            n_ne++;
            fprintf(log_file_0, "\"temp%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"r\"];", n_temp - 1, n_op, n_ne, n_ne);
            n_ne++;
            fprintf(log_file_0, "\"temp%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"l\"];", n_temp, n_op, n_ne, n_ne);
            n_temp++;
            fprintf(log_file_0, "\"temp%d\" [label=\"temp%d\", att1=var, att2=loc, att3=float];\n", n_temp, n_temp);
            ...
            fprintf(log_file_0, "\"op%d\" [label=\"+\", att1=op];\n", n_op);
            n_ne++;
            fprintf(log_file_0, "\"q0_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"r\"];", n_q0, n_op, n_ne, n_ne);
            n_ne++;
            fprintf(log_file_0, "\"q1_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"l\"];", n_q1, n_op, n_ne, n_ne);
            n_temp++;
            fprintf(log_file_0, "\"temp%d\" [label=\"temp%d\", att1=var, att2=loc, att3=float];\n", n_temp, n_temp);
            n_ne++;
            fprintf(log_file_0, "\"op%d\" -> \"temp%d\" [label=\"%d\", ord=\"%d\"];", n_op, n_temp, n_ne, n_ne);
            ...
            fprintf(log_file_0, "\"Q1_%d\" [label=\"Q1\", att1=var, att2=loc, att3=short];\n", n_Q1);
            n_ne++;
            fprintf(log_file_0, "\"temp%d\" -> \"Q1_%d\" [label=\"%d\", ord=\"%d\"];", n_temp, n_Q1, n_ne, n_ne);
            //---------------------
            Q1 = q1 + q0;
            //---------------------
            n_op++;
            ...
            fprintf(log_file_0, "\"op%d\" [label=\"+\", att1=op];\n", n_op);
            n_ne++;
            fprintf(log_file_0, "\"s0_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"r\"];", n_s0, n_op, n_ne, n_ne);
            n_ne++;
            fprintf(log_file_0, "\"s1_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"l\"];", n_s1, n_op, n_ne, n_ne);
            n_temp++;
            fprintf(log_file_0, "\"temp%d\" [label=\"temp%d\", att1=var, att2=loc, att3=float];\n", n_temp, n_temp);
            n_ne++;
            fprintf(log_file_0, "\"op%d\" -> \"temp%d\" [label=\"%d\", ord=\"%d\"];", n_op, n_temp, n_ne, n_ne);
            ...
            fprintf(log_file_0, "\"S1_%d\" [label=\"S1\", att1=var, att2=loc, att3=short];\n", n_S1);
            n_ne++;
            fprintf(log_file_0, "\"temp%d\" -> \"S1_%d\" [label=\"%d\", ord=\"%d\"];", n_temp, n_S1, n_ne, n_ne);
            //---------------------
            S1 = s1 + s0;
            //---------------------
            n_op++;
            ...
            fprintf(log_file_0, "\"op%d\" [label=\"*\", att1=op];\n", n_op);
            n_ne++;
            fprintf(log_file_0, "\"S1_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"r\"];", n_S1, n_op, n_ne, n_ne);
            n_ne++;
            fprintf(log_file_0, "\"c1_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"l\"];", n_c1, n_op, n_ne, n_ne);
            n_temp++;
            fprintf(log_file_0, "\"temp%d\" [label=\"temp%d\", att1=var, att2=loc, att3=float];\n", n_temp, n_temp);
            n_ne++;
            fprintf(log_file_0, "\"op%d\" -> \"temp%d\" [label=\"%d\", ord=\"%d\"];", n_op, n_temp, n_ne, n_ne);
            ...
            fprintf(log_file_0, "\"op%d\" [label=\"*\", att1=op];\n", n_op);
            n_ne++;
            fprintf(log_file_0, "\"Q1_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"r\"];", n_Q1, n_op, n_ne, n_ne);
            n_ne++;
            fprintf(log_file_0, "\"c7_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"l\"];", n_c7, n_op, n_ne, n_ne);
            n_temp++;
            fprintf(log_file_0, "\"temp%d\" [label=\"temp%d\", att1=var, att2=loc, att3=float];\n", n_temp, n_temp);
            n_ne++;
            fprintf(log_file_0, "\"op%d\" -> \"temp%d\" [label=\"%d\", ord=\"%d\"];", n_op, n_temp, n_ne, n_ne);
            ...
            n_ne++;
            fprintf(log_file_0, "\"temp%d\" -> \"F1_%d\" [label=\"%d\", ord=\"%d\"];", n_temp, n_F1, n_ne, n_ne);
            //---------------------
            F1 = c7 * Q1 + c1 * S1;
            //---------------------
            n_op++;
            ...
            n_ne++;
            fprintf(log_file_0, "\"temp%d\" -> \"F7_%d\" [label=\"%d\", ord=\"%d\"];", n_temp, n_F7, n_ne, n_ne);
            //---------------------
            F7 = c7 * S1 - c1 * Q1;
            //---------------------
            n_op++;
            ...
            fprintf(log_file_0, "\"S0_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"r\"];", n_S0, n_op, n_ne, n_ne);
            n_ne++;
            fprintf(log_file_0, "\"c5_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"l\"];", n_c5, n_op, n_ne, n_ne);
            n_temp++;
            fprintf(log_file_0, "\"temp%d\" [label=\"temp%d\", att1=var, att2=loc, att3=float];\n", n_temp, n_temp);
            n_ne++;
            fprintf(log_file_0, "\"op%d\" -> \"temp%d\" [label=\"%d\", ord=\"%d\"];", n_op, n_temp, n_ne, n_ne);
            ...
            fprintf(log_file_0, "\"Q0_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"r\"];", n_Q0, n_op, n_ne, n_ne);
            n_ne++;
            fprintf(log_file_0, "\"c3_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"l\"];", n_c3, n_op, n_ne, n_ne);
            n_temp++;
            fprintf(log_file_0, "\"temp%d\" [label=\"temp%d\", att1=var, att2=loc, att3=float];\n", n_temp, n_temp);
            n_ne++;
            fprintf(log_file_0, "\"op%d\" -> \"temp%d\" [label=\"%d\", ord=\"%d\"];", n_op, n_temp, n_ne, n_ne);
            ...
            n_ne++;
            fprintf(log_file_0, "\"temp%d\" -> \"F5_%d\" [label=\"%d\", ord=\"%d\"];", n_temp, n_F5, n_ne, n_ne);
            //---------------------
            F5 = c3 * Q0 + c5 * S0;
            //---------------------
            n_op++;
            ...
            n_ne++;
            fprintf(log_file_0, "\"temp%d\" -> \"F3_%d\" [label=\"%d\", ord=\"%d\"];", n_temp, n_F3, n_ne, n_ne);
            //---------------------
            F3 = c3 * S0 - c5 * Q0;
            //---------------------
            n_dct_io_tmp[0 + i_1]++;
            ...
            n_ne++;
            fprintf(log_file_0, "\"temp%d\" -> \"dct_io_tmp[%d]_%d_l\" [label=\"%d\", ord=\"%d\"];", n_temp, 8 + i_1, n_dct_io_tmp[8 + i_1], n_ne, n_ne);
            //---------------------
            ...
            n_ne++;
            fprintf(log_file_0, "\"temp%d\" -> \"dct_io_tmp[%d]_%d_l\" [label=\"%d\", ord=\"%d\"];", n_temp, 16 + i_1, n_dct_io_tmp[16 + i_1], n_ne, n_ne);
            //---------------------
            ...
            n_ne++;
            fprintf(log_file_0, "\"temp%d\" -> \"dct_io_tmp[%d]_%d_l\" [label=\"%d\", ord=\"%d\"];", n_temp, 24 + i_1, n_dct_io_tmp[24 + i_1], n_ne, n_ne);
            //---------------------
            ...
            fprintf(log_file_0, "\"const%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"r\"];", n_const, n_op, n_ne, n_ne);
            n_ne++;
            fprintf(log_file_0, "\"F5_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"l\"];", n_F5, n_op, n_ne, n_ne);
            n_temp++;
            fprintf(log_file_0, "\"temp%d\" [label=\"temp%d\", att1=var, att2=loc, att3=float];\n", n_temp, n_temp);
            n_ne++;
            fprintf(log_file_0, "\"op%d\" -> \"temp%d\" [label=\"%d\", ord=\"%d\"];", n_op, n_temp, n_ne, n_ne);
            ...
            n_ne++;
            fprintf(log_file_0, "\"temp%d\" -> \"dct_io_tmp[%d]_%d_l\" [label=\"%d\", ord=\"%d\"];", n_temp, 40 + i_1, n_dct_io_tmp[40 + i_1], n_ne, n_ne);
            //---------------------
            ...
            fprintf(log_file_0, "\"const%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"r\"];", n_const, n_op, n_ne, n_ne);
            n_ne++;
            fprintf(log_file_0, "\"F6_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"l\"];", n_F6, n_op, n_ne, n_ne);
            n_temp++;
            fprintf(log_file_0, "\"temp%d\" [label=\"temp%d\", att1=var, att2=loc, att3=float];\n", n_temp, n_temp);
            n_ne++;
            fprintf(log_file_0, "\"op%d\" -> \"temp%d\" [label=\"%d\", ord=\"%d\"];", n_op, n_temp, n_ne, n_ne);
            ...
            n_ne++;
            fprintf(log_file_0, "\"temp%d\" -> \"dct_io_tmp[%d]_%d_l\" [label=\"%d\", ord=\"%d\"];", n_temp, 48 + i_1, n_dct_io_tmp[48 + i_1], n_ne, n_ne);
            //---------------------
            ...
            fprintf(log_file_0, "\"const%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"r\"];", n_const, n_op, n_ne, n_ne);
            n_ne++;
            fprintf(log_file_0, "\"F7_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"l\"];", n_F7, n_op, n_ne, n_ne);
            n_temp++;
            fprintf(log_file_0, "\"temp%d\" [label=\"temp%d\", att1=var, att2=loc, att3=float];\n", n_temp, n_temp);
            n_ne++;
            fprintf(log_file_0, "\"op%d\" -> \"temp%d\" [label=\"%d\", ord=\"%d\"];", n_op, n_temp, n_ne, n_ne);
            ...
            n_ne++;
            fprintf(log_file_0, "\"temp%d\" -> \"dct_io_tmp[%d]_%d_l\" [label=\"%d\", ord=\"%d\"];", n_temp, 56 + i_1, n_dct_io_tmp[56 + i_1], n_ne, n_ne);
            //---------------------
            dct_io_tmp[56 + i_1] = F7 >> 13;
            //---------------------
            n_op++;
            fprintf(log_file_0, "\"op%d\" [label=\"post_inc\", att1=op];\n", n_op);
            n_const++;
            fprintf(log_file_0, "\"const%d\" [label=\"1\", att1=const];\n", n_const);
            n_ne++;
            fprintf(log_file_0, "\"const%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"r\"];", n_const, n_op, n_ne, n_ne);
            n_ne++;
            fprintf(log_file_0, "\"i_1_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"l\"];", n_i_1, n_op, n_ne, n_ne);
            n_i_1++;
            fprintf(log_file_0, "\"i_1_%d\" [label=\"i_1\", att1=var, att2=loc, att3=int];\n", n_i_1);
            n_ne++;
            fprintf(log_file_0, "\"op%d\" -> \"i_1_%d\" [label=\"%d\", ord=\"%d\"];", n_op, n_i_1, n_ne, n_ne);
            //---------------------
            i_1++;
        }
        //---------------------
    ...
    for (i = 0; i < 8 * num_fdcts; i++)
    {
        ...
        //---------------------
        n_const++;
        fprintf(log_file_0, "\"const%d\" [label=\"6\", att1=const];\n", n_const);
        n_op++;
        fprintf(log_file_0, "\"op%d\" [label=\"+\", att1=op];\n", n_op);
        n_ne++;
        fprintf(log_file_0, "\"const%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"r\"];", n_const, n_op, n_ne, n_ne);
        ...
        n_ne++;
        fprintf(log_file_0, "\"temp%d\" -> \"F0r_%d\" [label=\"%d\", ord=\"%d\"];", n_temp, n_F0r, n_ne, n_ne);
        //---------------------
        F0r = (F0 + 0x0006) >> 3;
        //---------------------
        n_const++;
        ...
        n_ne++;
        fprintf(log_file_0, "\"temp%d\" -> \"F1r_%d\" [label=\"%d\", ord=\"%d\"];", n_temp, n_F1r, n_ne, n_ne);
        //---------------------
        F1r = (F1 + 0x7FFF) >> 16;
        //---------------------
        n_const++;
        ...
        n_ne++;
        fprintf(log_file_0, "\"temp%d\" -> \"F2r_%d\" [label=\"%d\", ord=\"%d\"];", n_temp, n_F2r, n_ne, n_ne);
        //---------------------
        F2r = (F2 + 0x7FFF) >> 16;
        //---------------------
        n_const++;
        ...
        n_ne++;
        fprintf(log_file_0, "\"temp%d\" -> \"F3r_%d\" [label=\"%d\", ord=\"%d\"];", n_temp, n_F3r, n_ne, n_ne);
        //---------------------
        F3r = (F3 + 0x7FFF) >> 16;
        //---------------------
        n_const++;
        fprintf(log_file_0, "\"const%d\" [label=\"4\", att1=const];\n", n_const);
        n_op++;
        fprintf(log_file_0, "\"op%d\" [label=\"+\", att1=op];\n", n_op);
        n_ne++;
        fprintf(log_file_0, "\"const%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"r\"];", n_const, n_op, n_ne, n_ne);
        n_ne++;
        fprintf(log_file_0, "\"F4_%d\" -> \"op%d\" [label=\"%d\", ord=\"%d\", pos=\"l\"];", n_F4, n_op, n_ne, n_ne);
        n_temp++;
        fprintf(log_file_0, "\"temp%d\" [label=\"temp%d\", att1=var, att2=loc, att3=float];\n", n_temp, n_temp);
        n_ne++;
        fprintf(log_file_0, "\"op%d\" -> \"temp%d\" [label=\"%d\", ord=\"%d\"];", n_op, n_temp, n_ne, n_ne);
        ...
        n_ne++;
        fprintf(log_file_0, "\"temp%d\" -> \"F4r_%d\" [label=\"%d\", ord=\"%d\"];", n_temp, n_F4r, n_ne, n_ne);
        //---------------------
        F4r = (F4 + 0x0004) >> 3;
        //---------------------
        n_const++;
        ...
        n_ne++;
        fprintf(log_file_0, "\"temp%d\" -> \"F5r_%d\" [label=\"%d\", ord=\"%d\"];", n_temp, n_F5r, n_ne, n_ne);
        //---------------------
        F5r = (F5 + 0x7FFF) >> 16;
        //---------------------
        n_const++;
        ...
        n_ne++;
        fprintf(log_file_0, "\"temp%d\" -> \"F6r_%d\" [label=\"%d\", ord=\"%d\"];", n_temp, n_F6r, n_ne, n_ne);
        //---------------------
        F6r = (F6 + 0x7FFF) >> 16;
        //---------------------
        n_const++;
        ...
        n_ne++;
        fprintf(log_file_0, "\"temp%d\" -> \"F7r_%d\" [label=\"%d\", ord=\"%d\"];", n_temp, n_F7r, n_ne, n_ne);
        //---------------------
        F7r = (F7 + 0x7FFF) >> 16;
        //---------------------
        n_dct_o[0 + i_1]++;
