...
FILE *input_fp = ((void *) 0);
FILE *output_fp = ((void *) 0);
int input_dsp(void *dest, int words, int data_type) {
   int success;
   int i;
   double *float_ptr;
   int *int_ptr;
   unsigned int *unsigned_ptr;
   if(input_fp == ((void *) 0) && (input_fp = fopen("input.dsp", "r")) == ((void *) 0)) {
   ...
   switch (data_type) {
      ...
      for(i = 0; i < words; i++) success = fscanf(input_fp, "%lf", &float_ptr[i]);
      break;
      case 1:
      int_ptr = (int *) dest;
      for(i = 0; i < words; i++) success = fscanf(input_fp, "%d", &int_ptr[i]);
      break;
      case 2:
      unsigned_ptr = (unsigned int *) dest;
      for(i = 0; i < words; i++) success = fscanf(input_fp, "%u", &unsigned_ptr[i]);
      break;
      case 3:
...
void output_dsp(void *src, int words, int data_type) {
   int i;
   double *float_ptr;
   int *int_ptr;
   unsigned int *unsigned_ptr;
   if(output_fp == ((void *) 0) && (output_fp = fopen("output.dsp", "w")) == ((void *) 0)) {
   ...
   switch (data_type) {
      ...
      for(i = 0; i < words; i++) fprintf(output_fp, "%lf\n", float_ptr[i]);
      break;
      case 1:
      int_ptr = (int *) src;
      for(i = 0; i < words; i++) fprintf(output_fp, "%d\n", int_ptr[i]);
      break;
      case 2:
      unsigned_ptr = (unsigned int *) src;
      for(i = 0; i < words; i++) fprintf(output_fp, "%u\n", unsigned_ptr[i]);
      break;
      case 3:
