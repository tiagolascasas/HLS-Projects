...
ctype knn(ftype xFeatures[NUM_FEATURES], ftype knownFeatures[NUM_KNOWN_POINTS][NUM_FEATURES], ctype knownClasses[NUM_KNOWN_POINTS])
{
    ...
    for (int i = 0; i < NUM_KNOWN_POINTS; i++)
    {
        ...
        for (int j = 0; j < NUM_FEATURES; j++)
        {
            ...
            ne++;
            fprintf(f, "distance_%d->op%d [label=\"%d\", ord=\"%d\", pos=\"r\"];\n", n_distance, n_op, ne);
            n_distance++;
            fprintf(f, "\"distance_%d\" [label=distance, att1=var, att2=loc, att3=float ];\n", n_distance);
            ne++;
            fprintf(f, "op%d->distance_%d [label=\"%d\", ord=\"%d\", mod=\"sqr(\"];\n", n_op, n_distance, ne);
            //---------------------
        ...
        for (int i = 0; i < K; i++)
        {
            ...
            ne++;
            fprintf(f, "\"dbest_%d\"->mux%d [label=\"%d\", ord=\"%d\", pos=\"t\"];\n", n_dbest, n_mux, ne, ne);
            ne++;
            fprintf(f, "\"max_%d\"->mux%d [label=\"%d\", ord=\"%d\", pos=\"f\"];\n", n_max, n_mux, ne, ne);
            n_max++;
            ...
            ne++;
            fprintf(f, "\"index_%d\"->mux%d [label=\"%d\", ord=\"%d\", pos=\"f\"];\n", n_index, n_mux, ne, ne);
            n_index++;
        ...
        fprintf(f, "\"op%d\"->mux%d [label=\"%d\", ord=\"%d\", pos=\"sel\"];\n", n_op, n_mux, ne, ne);
        ne++;
        fprintf(f, "\"distance_%d\"->mux%d [label=\"%d\", ord=\"%d\", pos=\"t\"];\n", n_distance, n_mux, ne, ne);
        ne++;
        fprintf(f, "\"dbest_%d\"->mux%d [label=\"%d\", ord=\"%d\", pos=\"f\"];\n", n_dbest, n_mux, ne, ne);
        ...
        fprintf(f, "\"op%d\"->mux%d [label=\"%d\", ord=\"%d\", pos=\"sel\"];\n", n_op, n_mux, ne, ne);
        ne++;
        fprintf(f, "\"knownClasses[%d]_%d_l\"->mux%d [label=\"%d\", ord=\"%d\", pos=\"t\"];\n", i, n_knownClasses[i], n_mux, ne, ne);
        ne++;
        fprintf(f, "\"cbest_%d\"->mux%d [label=\"%d\", ord=\"%d\", pos=\"f\"];\n", n_cbest, n_mux, ne, ne);
    ...
    fprintf(f, "\"op%d\"->mux%d [label=\"%d\", ord=\"%d\", pos=\"sel\"];\n", n_op, n_mux, ne, ne);
    ne++;
    fprintf(f, "\"c2_%d\"->mux%d [label=\"%d\", ord=\"%d\", pos=\"t\"];\n", n_c2, n_mux, ne, ne);
    ne++;
    fprintf(f, "\"c1_%d\"->mux%d [label=\"%d\", ord=\"%d\", pos=\"f\"];\n", n_c1, n_mux, ne, ne);
    n_classID++;
    fprintf(f, "\"classID_%d\" [label=\"classID\", att1=var, att2=loc, att3=char ];\n", n_classID);
    ne++;
    ...
    fprintf(f, "\"op%d\"->mux%d [label=\"%d\", ord=\"%d\", pos=\"sel\"];\n", n_op, n_mux, ne, ne);
    ne++;
    fprintf(f, "\"d2_%d\"->mux%d [label=\"%d\", ord=\"%d\", pos=\"t\"];\n", n_d2, n_mux, ne, ne);
    ne++;
    fprintf(f, "\"c1_%d\"->mux%d [label=\"%d\", ord=\"%d\", pos=\"f\"];\n", n_c1, n_mux, ne, ne);
    n_mindist++;
    fprintf(f, "\"mindist_%d\" [label=\"mindist\", att1=var, att2=loc, att3=double ];\n", n_mindist);
    ...
    fprintf(f, "\"op%d\"->mux%d [label=\"%d\", ord=\"%d\", pos=\"sel\"];\n", n_op, n_mux, ne, ne);
    ne++;
    fprintf(f, "\"c3_%d\"->mux%d [label=\"%d\", ord=\"%d\", pos=\"t\"];\n", n_c3, n_mux, ne, ne);
    ne++;
    fprintf(f, "\"c1_%d\"->mux%d [label=\"%d\", ord=\"%d\", pos=\"f\"];\n", n_c1, n_mux, ne, ne);
    n_classID++;
    fprintf(f, "\"classID_%d\" [label=\"classID\", att1=var, att2=loc, att3=char ];\n", n_classID);
    ...
    fprintf(f, "\"op%d\"->mux%d [label=\"%d\", ord=\"%d\", pos=\"sel\"];\n", n_op, n_mux, ne, ne);
    ne++;
    fprintf(f, "\"c1_%d\"->mux%d [label=\"%d\", ord=\"%d\", pos=\"t\"];\n", n_c1, n_mux, ne, ne);
    ne++;
    fprintf(f, "\"classID_%d\"->mux%d [label=\"%d\", ord=\"%d\", pos=\"f\"];\n", n_classID, n_mux, ne, ne);
    n_classID++;
    fprintf(f, "\"classID_%d\" [label=\"classID\", att1=var, att2=loc, att3=char ];\n", n_classID);
    ne++;
    fprintf(f, "\"mux%d\"->classID_%d [label=\"%d\", ord=\"%d\", pos=\"l\"];\n", n_mux, n_classID, ne, ne);
