...
// top-level function
#pragma SDS data access_pattern(frames                \
                                : SEQUENTIAL, outputs \
                                : SEQUENTIAL)
...
GRAD_Z_OUTER:
    ...
    GRAD_Z_INNER:
        ...
        {
#pragma HLS pipeline II = 1
            gradient_z[r][c] = ((pixel_t)(frame1[r][c] * GRAD_WEIGHTS[0] + frame2[r][c] * GRAD_WEIGHTS[1] + frame3[r][c] * GRAD_WEIGHTS[2] + frame4[r][c] * GRAD_WEIGHTS[3] + frame5[r][c] * GRAD_WEIGHTS[4])) / 12;
        }
    }
}
