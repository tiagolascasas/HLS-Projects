...
void main()
  ...
  adpcm_decoder(sbuf, sbuf, NSAMPLES, &StateValprev, &StateIndex); 
...
void adpcm_decoder(int *indata, int *outdata, int len, int *state_valprev, int *state_index)
{
    int *inp;			/* Input buffer pointer */
    int *outp;			/* output buffer pointer */
    int sign;			/* Current adpcm sign bit */
