# 1 "vivado_hls_examples/euclidean_dist.c"
# 1 "vivado_hls_examples/euclidean_dist.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 8 "<command line>" 2
# 1 "<built-in>" 2
# 1 "vivado_hls_examples/euclidean_dist.c" 2
...
#pragma pack(pop)
# 2 "vivado_hls_examples/euclidean_dist.c" 2
# 1 "vivado_hls_examples/rsqrt.h" 1
...
# 2 "vivado_hls_examples/rsqrt.h" 2
...
# 3 "vivado_hls_examples/euclidean_dist.c" 2



float euclidean_dist(float a[1024], float b[1024]) {_ssdm_SpecArrayDimSize(a, 1024);_ssdm_SpecArrayDimSize(b, 1024);
 float dist = 0;
