...
void knn_graph_full(point x, point *known, int Nknown, bestpoint *BestPoints, int NFeatures, int KValue);
/**
...
ctype classifyKNN(bestpoint *BestPoints, int NClasses, int KValue); // generic version
