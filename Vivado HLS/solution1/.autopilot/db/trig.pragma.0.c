# 1 "vivado_hls_examples/trig.c"
# 1 "vivado_hls_examples/trig.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 8 "<command line>" 2
# 1 "<built-in>" 2
# 1 "vivado_hls_examples/trig.c" 2
...
#pragma pack(pop)
# 2 "vivado_hls_examples/trig.c" 2



float sine_sum(float coef[1024], float weight[1024], float x) {_ssdm_SpecArrayDimSize(coef, 1024);_ssdm_SpecArrayDimSize(weight, 1024);
 float sum = 0;
...
float cosine_sum(float coef[1024], float weight[1024], float x) {_ssdm_SpecArrayDimSize(coef, 1024);_ssdm_SpecArrayDimSize(weight, 1024);
 float sum = 0;
 for (int i = 0; i < 1024; i++)
