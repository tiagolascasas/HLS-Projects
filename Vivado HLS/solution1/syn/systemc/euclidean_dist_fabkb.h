...
// ==============================================================
#ifndef __euclidean_dist_fabkb__HH__
#define __euclidean_dist_fabkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(euclidean_dist_fabkb) {
    ...
    SC_CTOR(euclidean_dist_fabkb):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
