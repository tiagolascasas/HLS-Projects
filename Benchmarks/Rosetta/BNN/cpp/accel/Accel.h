...
#pragma SDS data access_pattern(dmem_i               \
                                : SEQUENTIAL, dmem_o \
                                : SEQUENTIAL)
#pragma SDS data access_pattern(wt_i               \
                                : SEQUENTIAL, kh_i \
                                : SEQUENTIAL)
#pragma SDS data mem_attribute(dmem_i                        \
                               : PHYSICAL_CONTIGUOUS, dmem_o \
                               : PHYSICAL_CONTIGUOUS)
#pragma SDS data mem_attribute(wt_i                        \
                               : PHYSICAL_CONTIGUOUS, kh_i \
                               : PHYSICAL_CONTIGUOUS)
#pragma SDS data data_mover(dmem_i                  \
                            : AXIDMA_SIMPLE, dmem_o \
                            : AXIDMA_SIMPLE)
#pragma SDS data data_mover(wt_i                  \
                            : AXIDMA_SIMPLE, kh_i \
                            : AXIDMA_SIMPLE)
void top(
    Word wt_i[WT_WORDS],
