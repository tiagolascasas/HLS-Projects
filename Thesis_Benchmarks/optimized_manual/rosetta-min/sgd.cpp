...
#pragma SDS data mem_attribute(data                                         \
                               : NON_CACHEABLE | PHYSICAL_CONTIGUOUS, label \
                               : CACHEABLE | PHYSICAL_CONTIGUOUS, theta     \
                               : CACHEABLE | PHYSICAL_CONTIGUOUS)
#pragma SDS data data_mover(data               \
                            : AXIDMA_SG, label \
                            : AXIFIFO, theta   \
                            : AXIDMA_SG)
#pragma SDS data sys_port(data         \
                          : AFI, label \
                          : AFI, theta \
                          : AFI)
...
#pragma SDS data access_pattern(data                \
                                : SEQUENTIAL, label \
                                : SEQUENTIAL, theta \
                                : SEQUENTIAL)
